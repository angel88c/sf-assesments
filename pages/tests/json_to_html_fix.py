data = {
    ...
    'country': 'Mexico',
    'date': '2025-06-02',
    'quotation_required_date': '2025-06-09',
    'contact_email': 'luis.velasco@ibtest.com',
    'customer_name2': '',
    'contact_phone': '',
    'is_duplicated': 'No',
    
    'file_types': {
        '*CAD files (Odb ++, *.cad, *.neu, *.fab, *.pad, *.asc, *.ipc, etc)': True,
        'Gerber files': False,
    ...
    'product_use_type': 'Single Product',
    'product_use_type_comments': '',
    'test_type': 'ICT',
    'test_type_comments': '',
    'dut_assembly_level': 'Housing',
    'dut_assembly_level_comments': '',

    'Panel Test? (Qty boards on panel)': {
        'Status': 'Yes', 'Qty': 0, 'Comments': ''
    },
    ...
    'purpose_fixture': 'Off-line',
    'purpose_fixture_comments': '',
    'pcb_side': '',
    ...
    'dut_test_points': False,
    'dut_test_points_comments': '',
    'dut_connectors': False,
    'dut_connectors_comments': '',
    'dut_through_hole': False,
    'dut_through_hole_comments': '',
    'dut_wire_harness': False,
    'dut_wire_harness_comments': '',
    'dut_rf_coaxial': False,
    'dut_rf_coaxial_comments': '',
    'dut_other': False,
    'dut_other_comments': '',
